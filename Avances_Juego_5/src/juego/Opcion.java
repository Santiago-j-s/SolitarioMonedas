...
public class Opcion
	{
		...
		/**
		 * Crea una opción con el título y el valor de verdad
		 * 		pasados como parámetros
		 * @param titulo - El nombre que tendrá la opción
		 * @param valorOpcion - El valor booleano que tendrá la opción
		 */
		 ...
		 * @param tituloOpcion - el nombre de la opción
		 */
		 ...
		 * @param esCorrecta - el valor de verdad de la opción
		 */
